...
import Card from '!!json!docgen/Card.json';
import CardActionOverlay from '!!json!docgen/CardActionOverlay.json';
import CardActions from '!!json!docgen/CardActions.json';
import CardMedia from '!!json!docgen/CardMedia.json';
import CardText from '!!json!docgen/CardText.json';
import CardTitle from '!!json!docgen/CardTitle.json';
